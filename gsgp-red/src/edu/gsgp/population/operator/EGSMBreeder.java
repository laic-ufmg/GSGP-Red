...
public class EGSMBreeder extends Breeder{

    // Elitist Geometric Semantic Mutation
    public EGSMBreeder(PropertiesManager properties, Double probability) {
    ...
    public Breeder softClone(PropertiesManager properties) {
        return new EGSMBreeder(properties, probability);
    }
}